...
import logo from '../assets/logoadidev.png';
...
const Navigation = ({ activeSection, scrollToSection }) => {
  ...
  return (
    <>
      {/* Logo */}
      <div className="fixed top-2 left-4 sm:left-6 z-50">
        <img src={logo} alt="AdiDev Logo" className="h-14 sm:h-16 md:h-20 lg:h-24 w-auto" />
      </div>
